...
<script language="javascript" type="text/javascript">
    ...
    br_form.getPrScode = function () {
        $("#pr_scode").getOption({//爭議組承辦人員
            url: getRootPath() + "/ajax/LookupDataCnn.aspx?type=GetPrScode&submitTask=A&pr_branch=" + $("#pr_branch").val(),
            valueFormat: "{scode}",
    ...
    br_form.getRsClass = function () {
        $("#pr_rs_class").getOption({
            url: getRootPath() + "/ajax/json_bjtrs_class.aspx?rs_type=" + $("#pr_rs_type").val(),
    ...
    $("#pr_rs_class").change(function () {
        $("#pr_rs_code").getOption({//案性
            url: getRootPath() + "/ajax/json_bjtrs_code.aspx?rs_type=" + $("#pr_rs_type").val() + "&rs_class=" + $("#pr_rs_class").val(),
    ...
    $("#pr_rs_code").change(function () {
        ...
        //        url: getRootPath() + "/ajax/json_bjtrs_class.aspx?rs_type=" + $("#pr_rs_type").val() + "&rs_code=" + $("#pr_rs_code").val(),
        //        valueFormat: "{rs_class}",
        //        textFormat: "{rs_class}_{rs_class_name}",
        //    });
        //}

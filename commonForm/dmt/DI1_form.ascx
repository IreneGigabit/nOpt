...
<table border="0" class="bluetable" cellspacing="1" cellpadding="2" width="100%">
	...
	<tr>
		...
		<td class=whitetablebg colspan="3">
			...
			共<input type="text" id="Pclass_count" name="Pclass_count" size=3 class="Lock">類(評定案依類別計算，請填具正確類別數)
		</TD>
	</tr>
	<tr>
		    ...
		    <table border="0" id=DI1_tabap class="bluetable" cellspacing="1" cellpadding="2" width="100%">
		        ...
		        <TR>
			        <TD  class=whitetablebg colspan=2 align=right>
				        ...
				        <input type=button value ="增加一筆註冊人" class="cbutton Lock" id=DI1_AP_Add_button name=DI1_AP_Add_button>
				        <input type=button value ="減少一筆註冊人" class="cbutton Lock" id=DI1_AP_Del_button name=DI1_AP_Del_button>
			        </TD>
		        </TR>
	            </THEAD>

    ...
    <thead>
	    <TR>
		    <TD align=center colspan=5 class=lightbluetable1>
                ...
                <input type="hidden" id="uploadfield" name="uploadfield" value="brdmt_">
    ...
    <tfoot>
		<TR>
			...
			<TD class=sfont9 colspan="2" align="left">
                ...
                <input type=button name='btnbrdmt_S_##' class='cbutton' value='檢視' onclick="brdmt_PreviewAttach('##')">
...
<script language="javascript" type="text/javascript">
    ...
    brupload_form.init = function () {
        if (brdmt_attach.length != 0) {
            $.each(brdmt_attach, function (i, item) {
                //增加一筆

...
<table border="0" class="bluetable" cellspacing="1" cellpadding="2" width="100%">
	...
	<tr>
		...
		<td class=whitetablebg colspan="3">
			...
			共<input type="text" id="Pclass_count" name="Pclass_count" size=3 class="Lock">類(廢止案依類別計算，請填具正確類別數)
		</TD>
	</tr>
	<tr>
		    ...
		    <table border="0" id=DR1_tabap class="bluetable" cellspacing="1" cellpadding="2" width="100%">
		        ...
		        <TR>
			        <TD  class=whitetablebg colspan=2 align=right>
				        ...
				        <input type=button value ="增加一筆註冊人" class="cbutton Lock" id=DR1_AP_Add_button name=DR1_AP_Add_button>
				        <input type=button value ="減少一筆註冊人" class="cbutton Lock" id=DR1_AP_Del_button name=DR1_AP_Del_button>
			        </TD>
		        </TR>
	            </THEAD>
	...
	<TR>
		<TD class=lightbluetable align=right></TD>
		<TD class=whitetablebg colspan=7>
            本案與<input TYPE=text id=Pitem1 NAME=Pitem1 SIZE=10 MAXLENGTH=10 class="dateField Lock">

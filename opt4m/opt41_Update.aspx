        ...
        for (int i = 1; i <= count; i++) {
            ...
            try {
                ...
                if (dt.Rows.Count != 0) {
                    ...
                    gs_date = dt.Rows[0].SafeRead("gs_date", "").Trim();
                    ...
                    rs_detail = dt.Rows[0].SafeRead("rs_detail", "").Trim();
                    ...
                    cappl_name = dt.Rows[0].SafeRead("appl_name", "").Trim();
                    eappl_name = dt.Rows[0].SafeRead("eappl_name", "").Trim();
                ...
                SQL += " '" + rs_no + "','" + Branch + "'," + seq + ",'" + seq1 + "','" + send_dept + "','" + gs_date + "'";
                SQL += ",'" + mp_date + "','G','S','" + send_cl + "','" + send_cl1 + "','" + send_sel + "'";
                ...
                string cnt = (objResult == DBNull.Value || objResult == null ? "0" : objResult.ToString());
                ...
                SQL += ") values (";
                SQL += "'B','" + Branch + "','" + seq + "','" + seq1 + "'," + Util.dbnull(br_in_date);
                ...
                SQL += ",'1','" + new_flag + "','" + case_new + "'," + Util.dbzero(fees) + "," + Util.dbnull(gs_date);
                SQL += "," + Util.dbnull(mp_date) + ",'" + cappl_name + "','" + eappl_name + "','" + s_mark + "','" + country + "'";
                SQL += "," + Util.dbnull(apply_date) + "," + apply_no + "," + Util.dbnull(issue_date);
                SQL += ",'" + issue_no + "','" + rej_no + "'," + Util.dbnull(open_date) + ",''";
                SQL += ",null," + Util.dbnull(term1) + "," + Util.dbnull(term2) + "," + Util.dbnull(end_date);
                ...
                using (SqlDataReader dr = conn.ExecuteReader(SQL)) {
                    ...
                    if (dr.HasRows) {
                        ...
                        string cnt2 = (objResult == DBNull.Value || objResult == null ? "0" : objResult.ToString());
                        if (Convert.ToInt32(cnt2) > 0) {
                            ...
                            Funcs.insert_log_table(conni, "D", "plus_temp", prgid, cond);
                    ...
                    while (dr.Read()) {
                        if (Convert.ToInt32("0" + dr.SafeRead("Bfees", "")) > 0) {
                            if (chk_type == "N") {
                                ...
                                SQL += "'1','" + DateTime.Now.ToShortTimeString() + "','" + Session["scode"] + "','" + step_date + "','" + Branch + "',";

    ...
    <div id="app">
        ...
        <ul>
            <li v-for="item in employees" :key="item.id">
                {{item.sysserver}}/{{item.syspath}}/{{item.sysnameC}}/{{item.syscode}}
            </li>
        </ul>
    </div>
</body>
...
var app = new Vue({
    ...
    created: function () {
        var self = this;
        self.employees = employeeService.get();
        /*$.get({
            ...
            self.employees=$.parseJSON(data.d).sysList;
        });*/

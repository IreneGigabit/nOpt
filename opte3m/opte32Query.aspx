...
<script runat="server">
    ...
    protected string HTProgPrefix = "opte32";//程式檔名前綴
...
<table style="display:none" border="0" class="bluetable" cellspacing="1" cellpadding="2" width="98%" align="center" id="dataList">
	...
	<tr class='{{tclass}}' id='tr_data_{{nRow}}'>
		...
		<td align="center" nowrap>
			<a href="{{href}}" target="Eblank">{{btnaction}}</a>
		</td>
	</tr>
	</tfoot>
	<tbody>
...
<br>
備註:<br>
1.承辦狀態為「已判行」或「已發文」或「註銷中」只能補對方號
</body>
</html>
            ...
            success: function (json) {
                ...
                $.each(JSONdata.pagedtable, function (i, item) {
                    ...
                    $("#dataList>tfoot").each(function (i) {
                        ...
                        strLine1 = strLine1.replace(/{{href}}/g, item.href);
                        strLine1 = strLine1.replace(/{{btnaction}}/g, item.btnaction);
                        ...
                        if(item.case_no!=""){
                            ...
                            urlasp="../opte2m/opte22EditA.aspx?opt_sqlno="+item.opt_sqlno+"&opt_no="+item.opt_no+"&branch="+item.branch+"&arcase="+item.arcase+"&prgid="+$("#prgid").val()+"&Submittask=Q"
                        }

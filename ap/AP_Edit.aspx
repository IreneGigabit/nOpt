...
<form id="reg" name="reg" method="post">
	...
	<input type="text" id="syscode" name="syscode" value="<%=syscode%>">
    ...
    <table border="0" class="bluetable" cellspacing="1" cellpadding="2" width="80%" align="center">	
		<TR>
		  ...
		  <TD class=whitetablebg><INPUT TYPE=text id=pfx_APcode NAME=pfx_APcode SIZE=10 MAXLENGTH=10  class="Lock"></TD>
		</TR>
		<TR>		  

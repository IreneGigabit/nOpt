        ...
        <table border="0" class="bluetable" cellspacing="1" cellpadding="2" width="70%" align="center">
	        <tr>
		        ...
		        <td class="whitetablebg" align="left" colspan="5">
			        <Select id="qry_law_type" name="qry_law_type"><%#qry_law_type%></Select>
		        </td> 
	        </tr>
	        <tr >
		        <td class=lightbluetable align=right nowrap>條文法規_條：</td>
		        <td class=whitetablebg > 
			        <input type="text" id='qry_law_no1' name='qry_law_no1' size="4" maxLength="4" >
		        </td>
		        <td class=lightbluetable align=right nowrap>條文法規_款：</td>
		        <td class=whitetablebg > 
			        <input type="text" id='qry_law_no2' name='qry_law_no2' size="4" maxLength="4" >
		        </td>
		        <td class=lightbluetable align=right nowrap>條文法規_項：</td>
		        <td class=whitetablebg > 
			        <input type="text" id='qry_law_no3' name='qry_law_no3' size="4" maxLength="4" >
		        </td>
	        </tr>   
	        <tr>
		        <td class="lightbluetable" align="right">法條內文 :</td>
		        <td class="whitetablebg" align="left" colspan="5">
			        <input type="text" id='qry_law_mark' name='qry_law_mark' size="100" maxLength="100" >
		        </td> 
	        </tr>
	        <tr>
		        <td class="lightbluetable" align="right">是否停用 :</td>
		        <td class="whitetablebg" align="left" colspan="5">
			        <label><input type="radio" name='qry_end_mark' value='Y' >是</label>
	                <label><input type="radio" name='qry_end_mark' value='N' >否</label>
	                <label><input type="radio" name='qry_end_mark' checked value='' >不指定</label>
		        </td> 
	        </tr>	
        </table>

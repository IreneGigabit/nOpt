...
<table style="display:none" border="0" class="bluetable" cellspacing="1" cellpadding="2" width="98%" align="center" id="dataList">
	...
	<tr class='{{tclass}}' id='tr_data_{{nRow}}'>
		...
		<td align="center">
            <a href="<%#HTProgPrefix%>Edit.aspx?opt_sqlno={{opt_sqlno}}&Case_no={{Case_no}}&Branch={{Branch}}&arcase={{arcase}}&todo_sqlno={{todo_sqlno}}&prgid=<%=prgid%>&prgname=<%#HTProgCap%>" target="Eblank">
                [確認]
            </a>
		</td>
	</tr>

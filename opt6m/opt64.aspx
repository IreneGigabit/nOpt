        ...
        <table border="0" class="bluetable" cellspacing="1" cellpadding="2" width="75%" align="center">	
	        ...
	        <tr>
		        ...
		        <td class="whitetablebg" align="left" colspan="3">
			        <label><input type="radio" value="N" name=qryinclude>不含附屬案性</label>
			        <label><input type="radio" value="Y" name=qryinclude>只印附屬案性</label>
			        <label><input type="radio" value="" name=qryinclude checked>全部</label>
		        </td> 
	        </tr>
            <tr >
	        ...
	        <tr>
		        ...
		        <td class="whitetablebg" align="left">
			        <label><input type="radio" value="NA" name=qryStatus>承辦中(包含未分案)</label>
...
<script language="javascript" type="text/javascript">
    $(function () {
        $("#spanclass").getCheckbox({//統計類別
            ...
            data:{sql:"Select * from cust_code where code_type='Oclass' order by cust_code"},
            objName: "qryPClass",

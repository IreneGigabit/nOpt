...
<script runat="server">
    protected string HTProgCap = "爭救案交辦品質評分表-統計";// HttpContext.Current.Request["prgname"];//功能名稱
    ...
    private void QueryData() {
        using (DBHelper conn = new DBHelper(Conn.OptK).Debug(Request["chkTest"] == "TEST")) {
            ...
            hSQL += "and b.code_type='OBranch' and b.sortfld is not null ";
            ...
            */
            ...
            SQL += "where b.code_type='OBranch' and b.sortfld is not null ";
            if ((Request["qryBranch"] ?? "") != "") {//區所

...
CKEDITOR.config.font_names = 'Arial/Arial, Helvetica, sans-serif;' +
    ...
    //自行定義其他字型
    '新細明體/新細明體, sans-serif; 標楷體/標楷體, sans-serif;MS PGothic/MS PGothic,sans-serif;';
...
//原先預設是px,配合outlook習慣，改成pt
//CKEDITOR.config.fontSize_sizes = '8/8px;9/9px;10/10px;11/11px;12/12px;14/14px;16/16px;18/18px;20/20px;22/22px;24/24px;26/26px;28/28px;36/36px;48/48px;72/72px';
//CKEDITOR.config.fontSize_sizes = '8px/8px;9px/9px;10px/10px;11px/11px;12px/12px;14px/14px;16px/16px;18px/18px;20px/20px;22px/22px;24px/24px;26px/26px;28px/28px;36px/36px;48px/48px;72px/72px';
CKEDITOR.config.fontSize_sizes = '8pt/8pt;9pt/9pt;10pt/10pt;11pt/11pt;12pt/12pt;14pt/14pt;16pt/16pt;18pt/18pt;20pt/20pt;22pt/22pt;24pt/24pt;26pt/26pt;28pt/28pt;36pt/36pt;48pt/48pt;72pt/72pt';

...
<script runat="server">
	...
	protected string HTProgPrefix = "UpLoadFile";
	...
	private void DoUpLoad() {
		...
		try {
			cn = new SqlConnection(Conn.ODBCDSN);
			cn.Open();
			...
			//okString = "BAD";
			//Funcs.errorLoggin(msgString, SQL, HTProgCode, trcString);
	...
	private void UpLoadFileLayout() {
		//Funcs.SetDropDownList(selDocRepeater, true, "GDoc", "");
	}
</script>
...
<select name="selDoc" size="1">
<asp:Repeater id="selDocRepeater" runat="server">
<ItemTemplate>
<option value="<%#DataBinder.Eval(Container.DataItem, "Value") %>"<%#DataBinder.Eval(Container.DataItem, "SelStr")%>><%#DataBinder.Eval(Container.DataItem, "Disp")%></option>
</ItemTemplate>
</asp:Repeater>
</select>
</td>
<td class="lightbluetable" align="right">檔案說明：</td>
<td class="whitetablebg">
<input type="text" name="nvReMark" value="<%#SrvrVal["szReMark"]%>" size="30" maxlength="150" />

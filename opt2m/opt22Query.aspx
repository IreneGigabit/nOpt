	...
	<tr class='{{tclass}}' id='tr_data_{{nRow}}'>
		...
		<td align="center" nowrap>
            <span id="tr_edit_{{nRow}}">
			    <a href="<%#HTProgPrefix%>Edit.aspx?opt_sqlno={{opt_sqlno}}&opt_no={{opt_no}}&branch={{Branch}}&case_no={{Case_no}}&arcase={{arcase}}&prgid=<%#prgid%>" target="Eblank">[判行]</a>
            </span>
            <span id="tr_editA_{{nRow}}">
			    <a href="<%#HTProgPrefix%>EditA.aspx?opt_sqlno={{opt_sqlno}}&opt_no={{opt_no}}&branch={{Branch}}&arcase={{arcase}}&prgid=<%#prgid%>&SubmitTask=U" target="Eblank">[判行]</a>
            </span>
		</td>
	</tr>
	</tfoot>
